...
void RulesParser::parseLine(string line, map<string, string> *definitions, map<string, string> *regexs,
...
void RulesParser::regularsParse(string line, map<string, string> *regMap, char delimiter)
{
    int eqPos = line.find('=');
    string lhs, rhs;
    int i = 0;
