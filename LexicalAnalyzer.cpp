...
void LexicalAnalyzer::startLexical()
{
    ...
    dfa.prettyPrintTransTable(dfa.transTable);
    dfa.print_accepted_Map();
    dfa.minimizeDFA();
    dfa.prettyPrintTransTable(dfa.transTable);
    dfa.print_accepted_Map();
...
{
    readFile.open("/home/rizk/Public/workspace/compiler5/tests/rules.txt");
    string line;
    RulesParser rParser;
...
{
    readFile.open("/home/rizk/Public/workspace/compiler5/tests/test.txt");
    string line;
